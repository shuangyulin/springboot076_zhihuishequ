    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="题目数" prop="timushu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="题目数"
                  v-model="ruleForm.timushu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.timushu" label="题目数" prop="timushu">
                    <span>{{ruleForm.timushu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
