  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.baoxiutupian" label="报修图片" prop="baoxiutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.baoxiutupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报修备注" prop="baoxiubeizhu">
          <el-input v-model="ruleForm.baoxiubeizhu" 
              placeholder="报修备注" clearable  :readonly="ro.baoxiubeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报修备注" prop="baoxiubeizhu">
              <el-input v-model="ruleForm.baoxiubeizhu" 
                placeholder="报修备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zaixianbaoxiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zaixianbaoxiuCrossAddOrUpdateFlag = false;
                  this.parent.search();
