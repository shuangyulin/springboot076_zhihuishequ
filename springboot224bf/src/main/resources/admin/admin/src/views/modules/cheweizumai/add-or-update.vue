<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位类别" prop="cheweileibie">
          <el-input v-model="ruleForm.cheweileibie" 
              placeholder="车位类别" clearable  :readonly="ro.cheweileibie"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="车位状态" prop="cheweizhuangtai">
          <el-input v-model="ruleForm.cheweizhuangtai" 
              placeholder="车位状态" clearable  :readonly="ro.cheweizhuangtai"></el-input>
        </el-form-item>
        <div v-else>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `cheweizumai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cheweizumaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
