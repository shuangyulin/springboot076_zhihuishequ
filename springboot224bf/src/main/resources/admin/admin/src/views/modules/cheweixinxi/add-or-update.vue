<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="车位类别" prop="cheweileibie">
          <el-select v-model="ruleForm.cheweileibie" placeholder="请选择车位类别">
            <el-option
                v-for="(item,index) in cheweileibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="车位类别" prop="cheweileibie">
	      <el-input v-model="ruleForm.cheweileibie"
                placeholder="车位类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="车位详情" prop="cheweixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.cheweixiangqing" label="车位详情" prop="cheweixiangqing">
                    <span v-html="ruleForm.cheweixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.cheweimingcheng = true;
          ...
          if(o=='cheweileibie'){
            this.ruleForm.cheweileibie = obj[o];
	    this.ro.cheweileibie = true;
            continue;
          }
          if(o=='cheweitupian'){
	...
	this.ruleForm.cheweixiangqing = this.ruleForm.cheweixiangqing.replace(reg,'../../../springboot224bf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
